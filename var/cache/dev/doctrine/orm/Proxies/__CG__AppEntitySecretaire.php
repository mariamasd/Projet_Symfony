 ...
 */
class Secretaire extends \App\Entity\Secretaire implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'analyses' => [parent::class, 'analyses', null],
        "\0".parent::class."\0".'creneaus' => [parent::class, 'creneaus', null],
        ...
        'analyses' => [parent::class, 'analyses', null],
        'creneaus' => [parent::class, 'creneaus', null],
