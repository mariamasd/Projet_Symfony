...
class getAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\Authenticator'])) {
            return $container->privates['App\\Security\\Authenticator'];
        }

        return $container->privates['App\\Security\\Authenticator'] = new \App\Security\Authenticator(($container->services['router'] ?? self::getRouterService($container)), $a);
    }
}
